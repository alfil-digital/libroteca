<div id="sidebar-wrapper" class="border-end shadow-sm overflow-auto">
    ...
    <div class="list-group list-group-flush pt-3">
        <a href="{{ route('catalogo') }}" class="nav-link-admin {{ request()->routeIs('catalogo') ? 'active' : '' }}">
        ...
        <a href="{{ route('courses.index') }}"
            class="nav-link-admin {{ request()->routeIs('courses.*') ? 'active' : '' }}">
            <i class="bi bi-camera-video me-3"></i> Cursos
        </a>

        <a href="{{ route('authors.index') }}"
            class="nav-link-admin {{ request()->routeIs('authors.*') ? 'active' : '' }}">
            <i class="bi bi-person-badge me-3"></i> Autores
        </a>

        <a href="{{ route('categories.index') }}"
            class="nav-link-admin {{ request()->routeIs('categories.*') ? 'active' : '' }}">
