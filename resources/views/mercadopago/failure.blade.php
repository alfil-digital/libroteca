        ...
        <div class="max-w-md w-full bg-white shadow-lg rounded-lg p-8">
            <div class="text-center">
                ...
                <div class="mt-6 bg-gray-50 rounded-lg p-4">
                    ...
                    <dl class="space-y-1">
                        ...
                        <div class="flex justify-between">
                            ...
                            <dd class="text-sm font-medium text-red-600">{{ $order->status }}</dd>
                        </div>
                        <div class="flex justify-between">
                ...
                <div class="mt-6 bg-red-50 rounded-lg p-4">
                    <h3 class="text-sm font-medium text-red-900 mb-2">Información del Error</h3>
                    <dl class="space-y-1">
                        <div class="flex justify-between">
                            <dt class="text-sm text-red-600">Estado:</dt>
                            <dd class="text-sm font-medium text-red-900">{{ ucfirst($status) }}</dd>
                        </div>
                    </dl>
                </div>
                @endif
